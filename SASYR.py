...
import time
# Aquí se debe agregar la configuración de Twilio
    ...
    if ret:
        ...
        for person in persons:
            ...
            if person.alert_shown and not person.danger_alert and current_time - person.initial_time >= danger_duration:
                ...
                body='El usuario KevinUwU Podria estar en una situacion de riesgo',
...
def start_camera(alert_duration=5, danger_duration=10):
